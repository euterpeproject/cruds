...
if ($fila > 0) {
        ...
        ?> 
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-header headererroreditar">
                    <h5 class="modal-title titleerroreditar">Error de ingreso</h5>
        ...
        $resultado = $mysqli->query("insert into contacto(name,phone,date,age,address,email)
                ...
                ?>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-header headereditarfinal">
                            <h5 class="modal-title titleeditarfinal">Contacto registrado</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        ...
                        <center><div class="alert alerteditarfinal alert-success alert-dismissible fade show" role="alert">
                                <strong>Registrado!</strong> Los datos de <b><?php echo "`$_REQUEST[name]`";?></b> se ingresaron correctamente.
                        </div></center>
